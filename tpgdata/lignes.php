...
function lineColor($l) {
    switch ($l) {
        ...
        case 'A':return 'FF6600';case 'B':return 'FF9999';case 'C':return 'FF6600';case 'D':return 'FF9999';case 'N':return 'FF9999';case 'N':return 'FF9BAA';case 'E':return 'FF6600';case 'F':return 'FF9999';
...
$lignesAvecTexteNoir = [2,12,19,28,34,42,43,45,53,57,61,63, "B", "Z","Y","T","O","K","G","F","M","D","N","NK","NM","NJ",'N'];
