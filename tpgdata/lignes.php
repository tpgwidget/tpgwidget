...
function lineColor($l) {
    switch ($l) {
        ...
        case '51':return '009999';case '53':return '99CCCC';case '54':return '009999';case '56':return '009999';case '57':return '99CCCC';case '61':return 'FF9BAA';
...
$lignesAvecTexteNoir = [2,12,19,28,34,42,43,45,53,57,61, "B", "Z","Y","T","O","K","G","F","M","D","DN","Dn","NK","NM","NJ",'N'];
$lignesAvecTexteBlanc = ['U', 'NV', '1', '3', '4', '5', '6', '7', '8', '9', '10', '11', '14', '15', '18', '21', '22', '23', '25', '31', '32', '33', '35', '36', '41', '44', '46', '47', '51', '52', '54', '56', 'A', 'C', 'E', 'J', 'L', 'NA', 'NC', 'ND', 'NE', 'NO', 'NP', 'NS', 'NT', 'P', 'S', 'TO', 'TT', 'V', 'W', 'X', 'G+', '5+', 'V+', 'C+', 'XA'];
